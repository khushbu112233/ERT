...
public class ReadUserDetails extends AsyncTask<String, Void, JSONObject>
    ...
    public ReadUserDetails(Activity activity, IResultListner iResultListner) {
...
//		mProgressHUD.setCanceledOnTouchOutside(false);
    ...
    protected JSONObject doInBackground(String... params) {
        try {
            ...
            return reader.ReadUserDetails(userID, auth);
        } catch (Exception e) {
            e.printStackTrace();
            isSuccess = false;
        }
