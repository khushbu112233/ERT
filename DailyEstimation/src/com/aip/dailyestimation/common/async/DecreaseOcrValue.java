...
public class DecreaseOcrValue extends AsyncTask<String, Void, JSONObject>
    ...
    public DecreaseOcrValue(Activity activity, IResultListner iResultListner) {
    ...
    protected JSONObject doInBackground(String... params) {
        try {
            ...
            return reader.DecreaseOCR(userID, auth);
        } catch (Exception e) {
            e.printStackTrace();
            isSuccess = false;
        }
