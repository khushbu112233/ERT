...
public class LogoutAsync extends AsyncTask<String, Void, JSONObject> implements OnCancelListener {
    ...
    public LogoutAsync(Activity activity, IResultListner iResultListner) {
    ...
    protected void onPreExecute() {
        mProgressHUD = ProgressHUD.show(activity, "Logout...", true, false, this);
    ...
    protected JSONObject doInBackground(String... params) {
        try {
            ...
            return reader.doLogout(activity);
        } catch (Exception e) {
            e.printStackTrace();
            isSuccess = false;
        }
