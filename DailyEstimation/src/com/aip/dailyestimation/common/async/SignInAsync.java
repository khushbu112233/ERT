...
public class SignInAsync extends AsyncTask<String, Void, JSONObject> implements OnCancelListener{
	...
	public SignInAsync(Activity activity, IResultListner iResultListner) {
	...
	protected JSONObject doInBackground(String... params) {
		try {
			...
			return reader.doLogin(username, password,activity);
		} catch (Exception e) {
			e.printStackTrace();
			isSuccess = false;
		}
