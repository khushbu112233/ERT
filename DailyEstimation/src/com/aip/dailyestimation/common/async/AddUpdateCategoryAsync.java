...
public class AddUpdateCategoryAsync extends AsyncTask<String, Void, JSONObject>
	...
	public AddUpdateCategoryAsync(Activity activity, CategoryBean categoryBean,
	...
	protected JSONObject doInBackground(String... params) {
		try {
			...
			if (Flag) {
				Log.d("Add Category", "Add Category");
				return reader.updateCategory(categoryBean, String
						.valueOf(DatabaseService.getInstance(activity)
								.getCurrentUserId()),auth);
			} else {
				Log.d("Update Category", "Update Category");
				return reader.addCategory(categoryBean, String
						.valueOf(DatabaseService.getInstance(activity)
								.getCurrentUserId()),auth);
			}
