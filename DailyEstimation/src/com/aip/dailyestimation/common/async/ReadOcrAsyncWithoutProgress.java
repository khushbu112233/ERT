...
public class ReadOcrAsyncWithoutProgress extends
        AsyncTask<String, Void, JSONObject> implements OnCancelListener {
    ...
    public ReadOcrAsyncWithoutProgress(Activity activity,
...
//		mProgressHUD.setCanceledOnTouchOutside(false);
    ...
    protected JSONObject doInBackground(String... params) {
        try {
            ...
            return reader.ReadOCR(userID, auth);
        } catch (Exception e) {
            e.printStackTrace();
            isSuccess = false;
        }
