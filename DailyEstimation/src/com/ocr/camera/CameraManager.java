...
import com.ocr.PreferencesActivity;
...
public final class CameraManager {
	...
	private static final int MIN_FRAME_WIDTH = 200; // originally 240
	private static final int MIN_FRAME_HEIGHT = 200; // originally 240
	private static final int MAX_FRAME_WIDTH = 700; // originally 480
	...
	public synchronized Rect getFramingRect() {
		if (framingRect == null) {
			...
			int width = screenResolution.x
					- (screenResolution.x * (cameraResolution.x / screenResolution.x));
			...
			int height = screenResolution.y
					- (screenResolution.y * (cameraResolution.y / screenResolution.y));
	...
	public PlanarYUVLuminanceSource buildLuminanceSource(byte[] data,
		...
		Log.e("rect.width(): " + rect.width(), "width: " + width);
		Log.e("rect.height(): " + rect.height(), "height: " + height);
		Log.e("rect.top: " + rect.top, "rect.bottom: " + rect.bottom);
		Log.e("rect.top: " + rect.top, "rect.left: " + rect.left);
		
		return new PlanarYUVLuminanceSource(data, width, height, 0, rect.top,
				width, rect.height(), reverseImage);
//		
